...
public class AbsED extends AppCompatActivity {
    String buttonvalue;
    Button startBtn;
    Button youtubeBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abs_ed);



        Intent intent = getIntent();
        int workoutPosition = intent.getIntExtra("workoutName", 1);
        Log.d("AbsED", "Received workoutPosition: " + workoutPosition);

        switch (workoutPosition) {


            case 1:
                Log.d("AbsED", "Case 1 triggered");
                setContentView(R.layout.a_crunches);
                setupYouTubeLinkButton("https://www.youtube.com/watch?v=hIkeJVV-Djk");
                break;
            case 2:
                Log.d("AbsED", "Case 2 triggered");
                setContentView(R.layout.a_reverse_crunches);
                setupYouTubeLinkButton("https://www.youtube.com/watch?v=xqvCmoLULNY");
                break;
            case 3:
                Log.d("AbsED", "Case 3 triggered");
                setContentView(R.layout.a_plank);
                setupYouTubeLinkButton("https://www.youtube.com/watch?v=xqvCmoLULNY");
                break;
            case 4:
                Log.d("AbsED", "Case 4 triggered");
                setContentView(R.layout.a_bicycle_crunches);
                setupYouTubeLinkButton("https://www.youtube.com/watch?v=xqvCmoLULNY");
                break;
            case 5:
                Log.d("AbsED", "Case 5 triggered");
                setContentView(R.layout.a_russian_twists);
                setupYouTubeLinkButton("https://www.youtube.com/watch?v=xqvCmoLULNY");
                break;
            case 6:
                Log.d("AbsED", "Case 6 triggered");
                setContentView(R.layout.a_leg_raises);
                setupYouTubeLinkButton("https://www.youtube.com/watch?v=xqvCmoLULNY");
                break;
            case 7:
                Log.d("AbsED", "Case 7 triggered");
                setContentView(R.layout.a_scissor_kicks);
                setupYouTubeLinkButton("https://www.youtube.com/watch?v=xqvCmoLULNY");
                break;
            ...
            private void startTimer() {
                ...
                countDownTimer = new CountDownTimer(MTimeLeftinmills, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        if (newvalue <= 7) {
                            Intent intent = new Intent(AbsED.this, AbsED.class);
